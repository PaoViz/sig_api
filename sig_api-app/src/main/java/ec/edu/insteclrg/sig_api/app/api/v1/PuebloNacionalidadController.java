...
public class PuebloNacionalidadController {
	...
	public ResponseEntity<Object> listar() {
		List<PuebloNacionalidadDTO> list = service.buscarTodo(new PuebloNacionalidadDTO());
		if (!list.isEmpty()) {
	...
	public ResponseEntity<Object> guardar(@RequestBody PuebloNacionalidadDTO PuebloNacionalidadDTO) {
		PuebloNacionalidadDTO PuebloNacionalidadDTOResult = service.guardar(PuebloNacionalidadDTO);
	...
	public ResponseEntity<Object> actualizar(@RequestBody PuebloNacionalidadDTO PuebloNacionalidadDTO) {
		PuebloNacionalidadDTO resultDTO = service.actualizar(PuebloNacionalidadDTO);
