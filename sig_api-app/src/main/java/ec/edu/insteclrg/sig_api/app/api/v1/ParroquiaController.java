...
import ec.edu.insteclrg.sig_api.service.crud.ParroquiaService;
...
public class ParroquiaController {
	...
	public ResponseEntity<Object> listar() {
		List<ParroquiaDTO> list = service.buscarTodo(new ParroquiaDTO());
		if (!list.isEmpty()) {
	...
	public ResponseEntity<Object> guardar(@RequestBody ParroquiaDTO ParroquiaDTO) {
		ParroquiaDTO ParroquiaDTOResult = service.guardar(ParroquiaDTO);
	...
	public ResponseEntity<Object> actualizar(@RequestBody ParroquiaDTO ParroquiaDTO) {
		ParroquiaDTO resultDTO = service.actualizar(ParroquiaDTO);
