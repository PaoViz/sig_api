...
public class EstadoCivilController {
	...
	public ResponseEntity<Object> listar() {
		List<EstadoCivilDTO> list = service.buscarTodo(new EstadoCivilDTO());
		if (!list.isEmpty()) {
	...
	public ResponseEntity<Object> guardar(@RequestBody EstadoCivilDTO EstadoCivilDTO) {
		EstadoCivilDTO EstadoCivilDTOResult = service.guardar(EstadoCivilDTO);
	...
	public ResponseEntity<Object> actualizar(@RequestBody EstadoCivilDTO EstadoCivilDTO) {
		EstadoCivilDTO resultDTO = service.actualizar(EstadoCivilDTO);
