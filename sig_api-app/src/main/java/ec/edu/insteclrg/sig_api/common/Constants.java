...
public class Constants {
	...
	public static final String URI_API_ETNIA = URI_API_V1 + "etnia";
	public static final String URI_API_CANTON = URI_API_V1 + "canton";
	public static final String URI_API_GENERO = URI_API_V1 + "genero";
	public static final String URI_API_PROVINCIA = URI_API_V1 + "provincia";
	...
	public static final String URI_API_PROYECTO_VINCULACION_PLANIFICACION = URI_API_V1 + "proyecto_vinculacion_planificacion";
	...
	public static final String URI_API_CONTRATO_LABORLA = URI_API_V1 + "contrato_laboral";
