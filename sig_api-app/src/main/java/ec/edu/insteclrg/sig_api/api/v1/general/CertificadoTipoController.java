...
import ec.edu.insteclrg.sig_api.service.general.CertificadoTipoService;
...
@Tag(name = "CertificadoTipo", description = "Gestiona un Tipo de Certificado (ej. PPP, Certificados Vinculacion etc.")
