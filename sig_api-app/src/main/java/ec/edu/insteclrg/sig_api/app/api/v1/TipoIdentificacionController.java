...
public class TipoIdentificacionController {
	...
	public ResponseEntity<Object> listar() {
		List<Tipo_IdentificacionDTO> list = service.buscarTodo(new Tipo_IdentificacionDTO());
		if (!list.isEmpty()) {
	...
	public ResponseEntity<Object> guardar(@RequestBody Tipo_IdentificacionDTO Tipo_IdentificacionDTO) {
		Tipo_IdentificacionDTO Tipo_IdentificacionDTOResult = service.guardar(Tipo_IdentificacionDTO);
	...
	public ResponseEntity<Object> actualizar(@RequestBody Tipo_IdentificacionDTO Tipo_IdentificacionDTO) {
		Tipo_IdentificacionDTO resultDTO = service.actualizar(Tipo_IdentificacionDTO);
