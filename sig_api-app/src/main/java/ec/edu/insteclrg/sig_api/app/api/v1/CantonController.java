...
public class CantonController {
	...
	public ResponseEntity<Object> listar() {
		List<CantonDTO> list = service.buscarTodo(new CantonDTO());
		if (!list.isEmpty()) {
	...
	public ResponseEntity<Object> guardar(@RequestBody CantonDTO CantonDTO) {
		CantonDTO CantonDTOResult = service.guardar(CantonDTO);
	...
	public ResponseEntity<Object> actualizar(@RequestBody CantonDTO CantonDTO) {
		CantonDTO resultDTO = service.actualizar(CantonDTO);
